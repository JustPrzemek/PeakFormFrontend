            ...
            <div className="p-3 text-gray-600 col-span-2">
                <div className="flex items-center">
                    ...
                    {isOwnProfile ? (
                        ...
                        <button className="bg-blue-500 ml-3 text-white font-semibold py-1 px-4 border border-blue-500 rounded text-sm cursor-pointer hover:bg-blue-600 transition-colors duration-200">
                            Follow
                        </button>
                    )}
                </div>
