...
const EmptyFeedPlaceholder = () => {
    return (
        <div className="text-center bg-white dark:bg-gray-800 rounded-lg p-8 my-4 shadow-md">
            ...
            <h3 className="mt-2 text-2xl font-semibold text-gray-900 dark:text-gray-100">Twój feed jest pusty</h3>
            <p className="mt-1 text-md text-gray-500 dark:text-gray-400">
                Zacznij obserwować innych użytkowników, aby zobaczyć ich posty.
            </p>
            <div className="mt-6">
                <Link
                    to="/explore/users"
